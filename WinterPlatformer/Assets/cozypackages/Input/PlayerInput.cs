...
public class PlayerInput : MonoBehaviour
{
    ...
    [SerializeField] private bool IncorporateSensitivity = false;
    ...
    [SerializeField] private bool MouseLockOnStart = true;
    ...
    void Start() 
    {
        ...
        if(MouseLockOnStart)
            MonoConsole.AttemptExecution("ms 2 ");
    }
    ...
    void Update()
    {
        ...
        if(IncorporateSensitivity)
            RawMouse = RawMouse * Sensitivity;
